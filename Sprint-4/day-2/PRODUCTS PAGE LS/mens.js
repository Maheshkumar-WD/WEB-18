...
var localStorageData = JSON.parse(localStorage.getItem("mensData"));
...
localStorageData.forEach(function (data){
  ...
  imgContainer.setAttribute("class","imgCont");
  img = document.createElement("img");
  img.setAttribute('src',data.image_url);
  imgContainer.append(img)

  var cardTextContainer = document.createElement("div");
  cardTextContainer.setAttribute("class","text-container");
  textDesc = document.createElement('div');
  textDesc.setAttribute("class","text-desc");
  ...
  textDesc.append(h5,price);
  cardTextContainer.append(textDesc,textDesc,btnContainer);

  box.append(imgContainer,cardTextContainer);
